...
class main_window(QtWidgets.QWidget):
    ...
    def __init__(self, sound_file, no_eve=False, test_trigger=False):
        ...
        self.plot = rft.RealTimeTrigger(self.data_source(no_eve=self.no_eve)[0], self.data_source(no_eve=self.no_eve)[1], _utc_folder, self.sound_file, self.no_eve, test_trigger=test_trigger)
